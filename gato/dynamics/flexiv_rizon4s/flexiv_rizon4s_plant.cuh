...
namespace plant {
        ...
        __device__ constexpr T JOINT_LIMITS_DATA[7][2] = {
            // from flexiv_rizon4s_kinematics.urdf
            {-2.7925 - JOINT_LIMIT_MARGIN<T>(), 2.7925 + JOINT_LIMIT_MARGIN<T>()},  // joint 0
            {-2.2689 - JOINT_LIMIT_MARGIN<T>(), 2.2689 + JOINT_LIMIT_MARGIN<T>()},  // joint 1
            {-2.9671 - JOINT_LIMIT_MARGIN<T>(), 2.9671 + JOINT_LIMIT_MARGIN<T>()},  // joint 2
            {-1.8675 - JOINT_LIMIT_MARGIN<T>(), 2.6878 + JOINT_LIMIT_MARGIN<T>()},  // joint 3
        ...
        __device__ constexpr T VEL_LIMITS_DATA[7][2] = {
            // from flexiv_rizon4s_kinematics.urdf
            {-2.0944 - JOINT_LIMIT_MARGIN<T>(), 2.0944 + JOINT_LIMIT_MARGIN<T>()},  // joint 0
            {-2.0944 - JOINT_LIMIT_MARGIN<T>(), 2.0944 + JOINT_LIMIT_MARGIN<T>()},  // joint 1
            {-2.4435 - JOINT_LIMIT_MARGIN<T>(), 2.4435 + JOINT_LIMIT_MARGIN<T>()},  // joint 2
            {-2.4435 - JOINT_LIMIT_MARGIN<T>(), 2.4435 + JOINT_LIMIT_MARGIN<T>()},  // joint 3
            {-4.8869 - JOINT_LIMIT_MARGIN<T>(), 4.8869 + JOINT_LIMIT_MARGIN<T>()},  // joint 4
            {-4.8869 - JOINT_LIMIT_MARGIN<T>(), 4.8869 + JOINT_LIMIT_MARGIN<T>()},   // joint 5
            {-4.8869 - JOINT_LIMIT_MARGIN<T>(), 4.8869 + JOINT_LIMIT_MARGIN<T>()}   // joint 6
        };

        template<class T>
        __device__ constexpr T CTRL_LIMITS_DATA[7][2] = {
            // from flexiv_rizon4s_kinematics.urdf
            {-123.0 - JOINT_LIMIT_MARGIN<T>(), 123.0 + JOINT_LIMIT_MARGIN<T>()},  // joint 0
            {-123.0 - JOINT_LIMIT_MARGIN<T>(), 123.0 + JOINT_LIMIT_MARGIN<T>()},  // joint 1
            {-64.0 - JOINT_LIMIT_MARGIN<T>(), 64.0 + JOINT_LIMIT_MARGIN<T>()},  // joint 2
            {-64.0 - JOINT_LIMIT_MARGIN<T>(), 64.0 + JOINT_LIMIT_MARGIN<T>()},  // joint 3
            {-39.0 - JOINT_LIMIT_MARGIN<T>(), 39.0 + JOINT_LIMIT_MARGIN<T>()},  // joint 4
            {-39.0 - JOINT_LIMIT_MARGIN<T>(), 39.0 + JOINT_LIMIT_MARGIN<T>()},   // joint 5
            {-39.0 - JOINT_LIMIT_MARGIN<T>(), 39.0 + JOINT_LIMIT_MARGIN<T>()}   // joint 6
        };
